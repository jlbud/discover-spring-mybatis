package com.klbud.discover.register;

import com.klbud.discover.annotation.DataSource;
import com.klbud.discover.config.DynamicDataSourceContextHolder;
import com.klbud.discover.config.DynamicRoutingDataSource;
...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata annotationMetadata, BeanDefinitionRegistry beanDefinitionRegistry) {
        ...
        logger.debug("注册数据源成功，一共注册{}个数据源", customDataSources.keySet().size() + 1);
    }
